...
suppliers = [
    ...
    ('Sphiwe Mashiyane', 'sphiwe@sphiwefarm.com', 'Farming', 'Sphiwe Mashiyane', 'Sphiwe Fruit & Veg Ltd.', 'Third Bank', 111111111, 1111, 2000.0)
]

for supplier in suppliers:
    cursor.execute('INSERT INTO suppliers (name, email, department, payment_made_to, company_name, bank_name, acc_number, branch_code, amount) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)', supplier)
